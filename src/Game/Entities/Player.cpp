...
Player::Player(double health, int baseDamage) : Entity(INIT_X, INIT_Y, 64, 64)  , Fighter(INIT_BATTLE_X, INIT_BATTLE_Y, 192, 192, health, baseDamage) {
...
void Player::inOverworldDraw() {
    ofDrawBitmapString("ow:" + to_string(ox), 400, 70);
    ofDrawBitmapString("oy:" + to_string(oy), 400, 90);
